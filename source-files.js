...
sourcesIndex["rusoto_core"] = {"name":"","dirs":[{"name":"proto","dirs":[{"name":"json","files":["error.rs","mod.rs","payload.rs"]},{"name":"xml","files":["error.rs","mod.rs","util.rs"]}],"files":["mod.rs"]}],"files":["client.rs","error.rs","future.rs","lib.rs","param.rs","region.rs","request.rs","serialization.rs","signature.rs","stream.rs"]};
sourcesIndex["rusoto_credential"] = {"name":"","files":["claims.rs","container.rs","environment.rs","instance_metadata.rs","lib.rs","profile.rs","request.rs","static_provider.rs"]};
